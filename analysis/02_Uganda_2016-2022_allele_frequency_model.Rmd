---
title: "Uganda 2016-2022: Selection coefficients analysis based on allele freuquency of K13 mutations"
  in Uganda
...
## Figure 2: Plot Allele frequency for all mutations with numobs>2
```{r}
numofobs <- 2
...
ggsave("figures/Figure2_model_fit_uganda/Uganda_model_fit_individual_mut_freq.png", freq_plot, width = 8, height = 5, dpi=700)
ggsave("figures/Figure2_model_fit_uganda/Uganda_model_fit_individual_mut_freq.pdf", freq_plot, width = 8, height = 5, dpi=700)
ggsave("figures/Figure2_model_fit_uganda/Uganda_model_fit_K13_freq.png", freq_PfK13_plot, width = 8, height = 5, dpi=700)
ggsave("figures/Figure2_model_fit_uganda/Uganda_model_fit_K13_freq.pdf", freq_PfK13_plot, width = 8, height = 5, dpi=700)
```
...
write.csv(effect_size_bay_freq, "figures/Figure3_selection_coefficient/Uganda/Uganda_selection_ceof_freq.csv")
```
...
ggsave("figures/Figure3_selection_coefficient/Uganda/Uganda_selection_coef_freq.png", selection_coef_bay_freq, width = 8, height = 9, dpi=700)
ggsave("figures/Figure3_selection_coefficient/Uganda/Uganda_selection_coef_freq.pdf", selection_coef_bay_freq,width = 8, height = 9, dpi=700)
```

## Statistical analysis of selection coefficients
```{r}
selec_ceof_stats_freq <- analysis_selection_coef(effect_size_bay_freq)
write.csv(selec_ceof_stats_freq, "figures/Figure3_selection_coefficient/Uganda/Uganda_selection_ceof_sanalysis_freq.csv")
```
