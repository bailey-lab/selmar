...
# Figure Supplement 7: Plot for selection coefficient 
## Preprocessing
```{r}
...
```{r}
ggsave(
  paste0(fileLocManuscript, "/supplement/Figure7-Uganda2021/Uganda2021_Effectsize.png"),
  selection_coef_bay,
  width = 8,
  height = 5,
  dpi = 700
...
ggsave(
  paste0(fileLocManuscript, "supplement/Figure7-Uganda2021/Uganda2021_Effectsize.pdf"),
  selection_coef_bay,
  width = 8,
  height = 5,
  dpi = 700
...
write.csv(
  ...
  paste0(fileLocManuscript, "/supplement/Figure7-Uganda2021/2021Uganda_selectioncoefficients.csv"),
  row.names = F,
  quote = F
)
```
...
write.csv(
  selec_ceof_stats,
  paste0(fileLocManuscript, "/supplement/Figure7-Uganda2021/2021Uganda_selectioncoefficients_stats.csv"),
  row.names = F,
  quote = F
)
```
