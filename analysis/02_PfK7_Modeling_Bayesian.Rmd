...
ggsave(paste0(fileLocManuscript_pfK7, "/supplement/SEAsia_prevalence.png"), prev_plot, width = 8, height = 8, dpi=700)
ggsave(paste0(fileLocManuscript_pfK7, "/supplement/SEAsia_prevalence.pdf"), prev_plot, width = 8, height = 8, dpi=700)
```
