...
ggsave(paste0(fileLocManuscript_pfK7, "/supplement/SEAsia_prevalence.png"), prev_plot, width = 8, height = 5, dpi=700)
ggsave(paste0(fileLocManuscript_pfK7, "/supplement/SEAsia_prevalence.pdf"), prev_plot, width = 8, height = 5, dpi=700)
```
...
ggsave(paste0(fileLocManuscript_pfK7, "/Figure3_SEAsia_Effectsize.png"), selection_coef_bay, width = 8, height = 5, dpi=700)
ggsave(paste0(fileLocManuscript_pfK7, "/Figure3_SEAsia_Effectsize.pdf"), selection_coef_bay, width = 8, height = 5, dpi=700)
write.csv(effect_size_bay2, paste0(fileLocManuscript_pfK7, "/SEAsia_selectioncoefficients.csv"), row.names = F,quote = F)
```
