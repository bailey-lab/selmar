...
```{r} 
pie_data <- pie_data2 %>% 
  select(year, District, A675V,C469Y, C469F, R561H, AllGenotyped) %>%
  group_by(year) %>%
...
write.csv(pie_data, file = paste0(fileLocManuscript,"/supplement/Figure3-UgandaMap/Figure3_stas.csv"))
```
