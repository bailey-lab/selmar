...
# Figure1: Overview of data plot Uganda
```{r}
...
# Figure2: Overview of data plot SE Asia (PfK7 data)
```{r}
plot_overview_seAsia <- df_pfk7 %>% 
  filter(Locus != "PfK13", is.finite(lrsmed), nobs <= numofobs) %>% 
  mutate(N = n+x) %>%
  ...
  theme(axis.line = element_line(), axis.text = element_text(size = 8), axis.title=element_text(size=12), legend.text=element_text(size=12), strip.text.x = element_text(size = 12), legend.title = element_text(size=12), legend.position = "right", legend.box = "vertical")
```

### Saving plot
```{r}
ggsave(
  paste0(fileLocManuscript, "/supplement/Figure2-SEAsia-DataOverview/SEAsia_dataoverview.pdf"),
...
ggsave(
  paste0(fileLocManuscript, "/supplement/Figure2-SEAsia-DataOverview/SEAsia_dataoverview.png"),
  plot_overview_seAsia,
  width = 8,
  height = 10,
  dpi = 700
...
ggsave(
  paste0(
    fileLocManuscript,
    "/ISMB2023-poster/SEAsia_map.pdf"
  ),
  map_SEAsia,
  width = 7.5,
  height = 6,
...
# Figure 5: Plotting forecasting of predictions for the first 2, 3, and 4 years with confidence values
```{r}
prev_cutoff_perc <- 50
...
ggsave(
  paste0(
    "figures/supplement/Figure5-Forecasting/C580Y/SEAsia_cutoff_",
    prev_cutoff_perc,
...
ggsave(
  paste0(
    "figures/supplement/Figure5-Forecasting/R539T/SEAsia_cutoff_",
    prev_cutoff_perc,
...
ggsave(
  paste0(
    "figures/supplement/Figure5-Forecasting/PfK13/SEAsia_cutoff_",
    prev_cutoff_perc,
