...
for (i in pred_year) {
  ...
  # forecasting
  new_data <- pfk7_data %>%
    filter(nobs > numofobs, is.finite(lrsmed)) %>% 
    mutate(Locus = "C580Y") %>%
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/per_district/50_cutoff_firstobs/larger_plot/SEAsia_cutoff_pred_C580Y_",
    prev_cutoff_perc,
    "prev_pred.pdf"
  ),
  prev_cutoff_c580y_plot,
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/per_district/50_cutoff_firstobs/larger_plot/SEAsia_cutoff_pred_R539T_",
    prev_cutoff_perc,
    "prev_pred.pdf"
  ),
  prev_cutoff_r539t_plot,
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/per_district/50_cutoff_firstobs/larger_plot/SEAsia_cutoff_pred_PfK13_",
    prev_cutoff_perc,
    "prev_pred.pdf"
  ),
  prev_cutoff_all_kelch_plot,
...
### Saving
```{r}
ggsave("figures/Figure4_PreahVihear_model.png",
  prev_PreahVihear_plot,
  width = 4.5,
  height = 3,
  dpi = 700
)
ggsave("figures/Figure4_PreahVihear_model.pdf",
  prev_PreahVihear_plot,
  width = 4.5,
  height = 3,
  dpi = 700
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/per_district/50_cutoff_PreahVihear/SEAsia_cutoff_pred_C580Y_PreahVihear_",
    prev_cutoff_perc,
    "avg_prev_pred.png"
  ),
  prev_cutoff_c580y_PreahVihear_plot,
