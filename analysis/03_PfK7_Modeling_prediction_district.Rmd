...
## Figure 7: Plotting forecasting of predictions for the first 2, 3, and 4 years with confidence intervals
```{r}
prev_cutoff_perc <- 50
################ PLOT FOR C580Y ################
df_pred <- df_predict_cutoff_allyear %>% 
...
ggsave(
  paste0(
    "figures/Figure6-Forecasting/C580Y/SEAsia_cutoff_",
    fig6_prev_cutoff_perc,
...
ggsave(
  paste0(
    "figures/Figure6-Forecasting/R539T/SEAsia_cutoff_",
    fig6_prev_cutoff_perc,
...
ggsave(
  paste0(
    "figures/Figure6-Forecasting/PfK13/SEAsia_cutoff_",
    fig6_prev_cutoff_perc,
