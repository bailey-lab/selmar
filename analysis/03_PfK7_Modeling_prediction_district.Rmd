...
correlation_plot_cutoff <- ggplot(corr_df_cutoff, aes(x = t_pred_prev, y = p_pred_prev, color = label, group = label)) +
  geom_point() +
...
correlation_plot_avg <- ggplot(corr_df_avg, aes(x = t_pred_prev, y = p_pred_prev, color = label, group = label)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE) +
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/per_district/20_cutoff_firstobs/SEAsia_correlation_",
    prev_cutoff_perc,
    "cutoff_prev.png"
  ),
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/per_district/20_avg/SEAsia_correlation_",
    prev_cutoff_perc,
    "avg_prev.png"
  ),
