...
# the K13 prevalence estimates in SEA
...
```{r}
ggsave(
  paste0(fileLocManuscript_pfK7, "/supplement/Figure5-SEAsiaPrevalence/SEAsia_posterior_prevalence.png"),
  prev_plot,
  width = 8,
  height = 8,
  dpi = 700
...
ggsave(
  paste0(fileLocManuscript_pfK7, "/supplement/Figure5-SEAsiaPrevalence/SEAsia_posterior_prevalence.pdf"),
  prev_plot,
  width = 8,
  height = 8,
  dpi = 700
