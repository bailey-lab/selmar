...
prev_plot <- prev_df  %>% mutate(N = n+x) %>%
  ...
  #scale_y_log10() +
  scale_color_manual(values=c("#56B4E9", "#E69F00", "#009E73"), name = "Mutations", labels = c("580Y", "PfK13", "539T")) + 
...
```{r}
ggsave(
  paste0(fileLocManuscript_pfK7, "/supplement/Figure4-SEAsiaPrevalence/SEAsia_posterior_prevalence.png"),
  prev_plot,
  width = 8,
  height = 8,
  dpi = 700
...
ggsave(
  paste0(fileLocManuscript_pfK7, "/supplement/Figure4-SEAsiaPrevalence/SEAsia_posterior_prevalence.pdf"),
  prev_plot,
  width = 8,
  height = 8,
  dpi = 700
