...
ggsave(paste0(fileLocManuscript, "/Figure2_Uganda_prevalence.png"), prev, width = 8, height = 5, dpi=700)
ggsave(paste0(fileLocManuscript, "/Figure2_Uganda_prevalence.pdf"), prev, width = 8, height = 5, dpi=700)
...
ggsave(paste0(fileLocManuscript, "/Figure3_Uganda_Effectsize.png"), selection_coef_bay,width = 8, height = 5, dpi=700)
ggsave(paste0(fileLocManuscript, "/Figure3_Uganda_Effectsize.pdf"), selection_coef_bay,width = 8, height = 5, dpi=700)
