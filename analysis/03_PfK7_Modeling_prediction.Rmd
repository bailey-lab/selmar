...
```{r}
#load data
pfk7_data <- read.table("data/pfk7_data.txt")
...
### MANUSCRIPT PLOTS ###
```{r}
fileLocManuscript_pfK7 <- "~/Dropbox (Brown)/Brown/PhD/Rotations/JeffBailey/Kelch_Uganda_Modeling/Results/20230120_Manuscript/Pfk7/"
```
...
# ggsave(paste0(fileLocManuscript_pfK7, "/predictions/C580Y_pred.jpeg"), prev_c580y_plot, width = 8, height = 8, dpi= 700)
# ggsave(paste0(fileLocManuscript_pfK7, "/predictions/R539T_pred.jpeg"), prev_r539t_plot, width = 8, height = 8, dpi= 700)
# ggsave(paste0(fileLocManuscript_pfK7, "/predictions/combinedPfK13_pred.jpeg"), prev_all_kelch_plot, width = 8, height = 8, dpi= 700)
# 
