...
prev_c580y_plot <- 
  ...
  geom_point(data = ex_pt, aes(x=year, y=prev_580y*100)) +
  ggtitle("C580Y") +
...
ggsave("figures/predictions/SE_Asia/SEAsia_pred_C580Y_pred.png", prev_c580y_plot, width = 8, height = 5, dpi=700)
ggsave("figures/predictions/SE_Asia/SEAsia_pred_C580Y_pred.pdf", prev_c580y_plot, width = 8, height = 5, dpi=700)
...
prev_r539t_plot <- 
  ...
  geom_line(data=df_pred, aes(year, exp(predict)*100/(1+exp(predict)), group = label,color = label), linetype = "dashed") +
  geom_point(data = ex_pt, aes(x=year, y=prev_539t*100)) +
  ggtitle("R539T") +
  labs(shape="Mutations", size = "Sample Size") +
  theme_bw() +
  facet_wrap(~country) +
...
ggsave("figures/predictions/SE_Asia/SEAsia_pred_R539T_pred.png", prev_r539t_plot, width = 8, height = 5, dpi=700)
ggsave("figures/predictions/SE_Asia/SEAsia_pred_R539T_pred.pdf", prev_r539t_plot, width = 8, height = 5, dpi=700)

## PLOT FOR ALL KELCH MUTATIONS
ex <- pfk7_data %>% filter(is.finite(lrsmed_all_kelch), nobs_kelch > numofobs)
ex_pt <- pfk7_data %>% filter(nobs_kelch > numofobs)
df_pred <- df_predict_allyear %>% 
...
prev_all_kelch_plot <- 
  ...
  geom_line(data=df_pred, aes(year, exp(predict)*100/(1+exp(predict)), group = label,color = label), linetype = "dashed") +
  geom_point(data = ex_pt, aes(x=year, y=prev_all_kelch*100)) +
  ggtitle("PfK13") +
  labs(shape="Mutations", size = "Sample Size") +
  theme_bw() +
  facet_wrap(~country) +
...
ggsave("figures/predictions/SE_Asia/SEAsia_pred_Pfk13_pred.png", prev_all_kelch_plot, width = 8, height = 5, dpi=700)
ggsave("figures/predictions/SE_Asia/SEAsia_pred_Pfk13_pred.pdf", prev_all_kelch_plot, width = 8, height = 5, dpi=700)
```
...
ggsave(paste0("figures/predictions/SE_Asia/20_cutoff_firstobs/SEAsia_pred_C580Y_", prev_cutoff_perc, "prev_pred.png"), prev_c580y_plot, width = 8, height = 5, dpi=700)
...
ggsave(paste0("figures/predictions/SE_Asia/20_cutoff_firstobs/SEAsia_pred_R539T_", prev_cutoff_perc, "prev_pred.png"), prev_r539t_plot, width = 8, height = 5, dpi=700)
...
ggsave(paste0("figures/predictions/SE_Asia/20_cutoff_firstobs/SEAsia_pred_PfK13_", prev_cutoff_perc, "prev_pred.png"), prev_all_kelch_plot, width = 8, height = 5, dpi=700)
```
...
```{r}
prev_cutoff_perc <- prev_cutoff *100
df_pred <- df_predict_avg_allyear %>% filter(year >= min_year + pred_y, Locus == "C580Y") 
ex <- pfk7_data %>% filter(is.finite(lrsmed_580y), nobs_c580y > numofobs, country %in% unique(df_pred$country))
ex_pt <- pfk7_data %>% filter(nobs_c580y > numofobs, country %in% unique(df_pred$country))
## PLOT FOR C580Y
prev_c580y_plot <- 
  ggplot() +
  geom_line(data=ex %>% mutate(N = n+c580y), aes(year, predict_stan_prev_c580y, color = "true"), linewidth = 1) + 
...
ggsave(paste0("figures/predictions/SE_Asia/20_avg/SEAsia_pred_C580Y_", prev_cutoff_perc, "avg_prev_pred.png"), prev_c580y_plot, width = 8, height = 5, dpi=700)

df_pred <- df_predict_avg_allyear %>% filter(year >= min_year +  pred_y, Locus == "R539T")  
ex <- pfk7_data %>% filter(is.finite(lrsmed_539t), nobs_r539t > numofobs, country %in% unique(df_pred$country))
ex_pt <- pfk7_data %>% filter(nobs_r539t > numofobs, country %in% unique(df_pred$country))
prev_r539t_plot <- 
  ggplot() +
  geom_line(data=ex %>% mutate(N = n+r539t), aes(year, predict_stan_prev_r539t, color = "true")) + 
  geom_line(data=df_pred, aes(year, exp(predict)*100/(1+exp(predict)), group = label,color = label), linetype = "dashed") +
...
ggsave(paste0("figures/predictions/SE_Asia/20_avg/SEAsia_pred_R539T_", prev_cutoff_perc, "avg_prev_pred.png"), prev_r539t_plot, width = 8, height = 5, dpi=700)

df_pred <- df_predict_avg_allyear %>% filter(year >= min_year +  pred_y, Locus == "all_kelch")  
ex <- pfk7_data %>% filter(is.finite(lrsmed_all_kelch), nobs_kelch > numofobs, country %in% unique(df_pred$country))
ex_pt <- pfk7_data %>% filter(nobs_kelch > numofobs, country %in% unique(df_pred$country))
prev_all_kelch_plot <- 
  ggplot() +
  geom_line(data=ex %>% mutate(N = n+all_kelch), aes(year, predict_stan_prev_all_kelch, color = "true")) + 
  geom_line(data=df_pred, aes(year, exp(predict)*100/(1+exp(predict)), group = label,color = label), linetype = "dashed") +
...
ggsave(paste0("figures/predictions/SE_Asia/20_avg/SEAsia_pred_PfK13_", prev_cutoff_perc, "avg_prev_pred.png"), prev_all_kelch_plot, width = 8, height = 5, dpi=700)
```
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/20_cutoff_firstobs/SEAsia_correlation_",
    prev_cutoff_perc,
    "cutoff_prev.png"
  ),
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/20_avg/SEAsia_correlation_",
    prev_cutoff_perc,
    "avg_prev.png"
  ),
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/20_cutoff_firstobs/SEAsia_correlation_R539T_",
    prev_cutoff_perc,
    "cutoff_prev.png"
  ),
  correlation_plot_cutoff,
...
ggsave(
  paste0(
    "figures/predictions/SE_Asia/20_avg/SEAsia_correlation_R539T_",
    prev_cutoff_perc,
    "avg_prev.png"
  ),
  correlation_plot_avg,
